...
function Linux.Create(config)
    ...
    local BetaLabel = Linux.Instance("Frame", {
        ...
        Position = UDim2.new(0, TitleLabel.TextBounds.X + 15, 0, 4),
        ZIndex = 2
    })
    ...
    local TabsBar = Linux.Instance("Frame", {
        ...
        Size = UDim2.new(0, config.TabWidth or 110, 0, 70),
        ZIndex = 2,
        BorderSizePixel = 0
    })
    ...
    local ProfileIcon = Linux.Instance("ImageLabel", {
        ...
        Image = Players:GetUserThumbnailAsync(LocalPlayer.UserId, Enum.ThumbnailType.AvatarBust, Enum.ThumbnailSize.Size100x100),
        ZIndex = 3
    })
    ...
    local Outline = Linux.Instance("Frame", {
        Parent = TabsBar,
